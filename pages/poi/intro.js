Page({
  ...
  onLoad() {
    ...
    const pages = [
      ...
      {
        title: "冲虚古观",
        img: "/static/img/5.png", // 道教庙宇景观-冲虚古观实景
        content:
      ...
      /*
       {
         title: "青菱园",
         img: "https://images.unsplash.com/photo-1416879595882-3373a0480b5b?auto=format&fit=crop&w=1600&q=80", // 古典园林景观
         content:
